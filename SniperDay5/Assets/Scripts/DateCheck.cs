...
public class DateCheck : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        voiceDate[5, 3] = voiceDate0422;
        voiceDate[5, 4] = voiceDate0422;
        voiceDate[5, 5] = voiceDate0422;
        voiceDate[6, 2] = voiceDate0422;
        voiceDate[7, 7] = voiceDate0422;
        voiceDate[7, 20] = voiceDate0422;
        voiceDate[8, 13] = voiceDate0422;
        voiceDate[9, 15] = voiceDate0422;
        voiceDate[9, 22] = voiceDate0422;
        voiceDate[10, 8] = voiceDate0422;
        voiceDate[10, 10] = voiceDate0422;
        voiceDate[11, 3] = voiceDate0422;
        voiceDate[11, 23] = voiceDate0422;
